            ...
            <table class="table table-striped table-condensed receipt">
                ...
                <tfoot>
					<tr>
						...
						<th class="text-right"><?= $this->erp->formatMoney($inv->grand_total); ?></th>
					</tr>
...
<?php } ?>
	...
	<span class="pull-right col-xs-12">
        <a href="<?=base_url()?>sales/invoice_poto/<?=$sid?>" target="_blank" class="btn btn-block btn-primary" ><?= lang("invoice_photo"); ?></a>
    </span>	
	<span class="pull-right col-xs-12">
